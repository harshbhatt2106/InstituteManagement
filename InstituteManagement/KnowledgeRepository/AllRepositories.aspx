<%@ Page Title="" Language="C#" MasterPageFile="~/KnowledgeRepository/KnowledgeRepository.Master" AutoEventWireup="true" CodeBehind="AllRepositories.aspx.cs" Inherits="InstituteManagement.KnowledgeRepository.ShowRepository" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DropDownList ID="CategoryList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="CategoryList_SelectedIndexChanged" CssClass="CategoryList">
        <asp:ListItem>Select Category</asp:ListItem>
    </asp:DropDownList><br />
    <asp:Button ID="ShowFavoriteContent" runat="server" CssClass="button" OnClick="ShowFavoriteContent_Click" Text="Show Favorite Content" />
    <asp:Label ID="lable" runat="server" Text="Knowladge Repository" CssClass="KnowladgeRepositorylable"></asp:Label>
        ...
        <ItemTemplate>
            <div class="ShowRepositories">
                <div class="lable">
                    ...
                    <asp:Button ID="AddToFevorite" OnClick="AddToFevorite_Click" runat="server" CssClass="AddToFevorite" Text="Add To Favorite" />
                </div>
            </div>
        </ItemTemplate>
    </asp:DataList>
